...
$result = mysqli_query($connection, "SELECT * FROM users INNER JOIN majorities ON majorities.id_majority = users.id_majority WHERE id_levels = 1 AND id_status = 3");
?>
<!DOCTYPE html>
<!--
...
<head>
    ...
    <title>PSBO Rejected List</title>
